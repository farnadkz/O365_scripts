...
#Start
$Groups = 'CCRM_Combined MFA & SSPR Registration', 'CCRM_Conditional Access Policies_Deployment', 'MFA required', 'C-PRJ-CCRM iLobby', 'MasterControl Enterprise Application', 'MEM_CORP - Automatic Enrollment - Windows', 'CCRM_Licensing_Microsoft Defender for Endpoint P2'#, 'Exclude from MFA'
...
foreach ($group in $Groups) {
    ...
    Catch {
        Write-Host "Error adding user" -ForegroundColor Orange
    }
